...
// Nombres en español escritos a mano (ver nota igual en conversation-flow.md:
// no dependemos del locale de date-fns, ya falló una vez en producción).
 ...
 * en formato compatible con la API de function calling de Gemini.
 */
