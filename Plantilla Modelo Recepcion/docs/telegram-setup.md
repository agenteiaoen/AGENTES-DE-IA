...
2. BotFather te preguntará:
   - **"¿Qué nombre quieres para tu bot?"** → Escribe algo como: `Mi Negocio Recepcionista Bot`
   - **"¿Qué nombre de usuario?"** → Escribe algo como: `MiNegocio_Recepcionista_bot` (debe terminar en `_bot`)

3. BotFather te responderá algo como:
   ```
   ✅ Done! Congratulations on your new bot. You'll find it at t.me/MiNegocio_Recepcionista_bot.
...
2. Busca tu bot en Telegram (a través de su @username)
3. Envía `/start`
4. Deberías ver el menú de bienvenida
...
2. Personaliza el negocio, servicios y horarios en `src/config.js`
3. ¡Disfruta! 🎉
